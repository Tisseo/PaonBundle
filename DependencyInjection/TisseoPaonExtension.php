...
class TisseoPaonExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        // Schematics upload directory
        $container->setParameter('tisseo_paon.schematics_directory', $config['schematics_directory']);
        $container->setParameter('tisseo_paon.schematics_relative_directory', $config['schematics_relative_directory']);
    }
}
